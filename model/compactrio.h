...
/**
 * @brief Singleton class that account for the "real" CRio device. The CompactRio instance is a local copy of the "real" CRio.
...
signals:
    ...
    void navSysNewLineInUse();                  ///< triggered when the navigation system begin to follow a new line
    void navSysWaypointReached(quint16 index);  ///< triggered when the catamaran reached the end of a line

private:
    /// disable copy constructor (setting it private) beacause this class is a singleton
